...
import cam.com.socialEcho.Profile.ProfileActivity;
        ...
        mUsername.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(getContext().getString(R.string.calling_activity),
                        getContext().getString(R.string.home_activity));
                intent.putExtra(getContext().getString(R.string.intent_user), mCurrentUser);
